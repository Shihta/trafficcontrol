...
to-setenv-before-enroll "QCT_CG_Edge_Remote_0" "TM_QCT" "RASCAL" "ONLINE"

to-enroll tm $CDN_NAME "QCT_CG_Edge_Remote_0" "$TM_PORT" "" "TM_QCT" "$MY_IP" || (while true; do echo "enroll failed."; sleep 3 ; done)
